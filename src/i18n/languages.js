 ...
 * MDoNER North Eastern Region & National Accessibility Module
 * Supports: English, Assamese (অসমীয়া), Hindi (हिंदी), Bengali (বাংলা), Telugu (తెలుగు), Tamil (தமிழ்)
 */

export const I18N = {
  en: {
    name: "English",
    systemTitle: "MDoNER Multi-Hazard Early Warning & Life-Saving System",
    roleCitizen: "Citizen Survival Hub",
    roleWarRoom: "MDoNER Command War Room",
    roleResponder: "NDRF / Quick Response",
    roleHospital: "Shelter & Hospital Hub",
    sosButton: "1-TAP EMERGENCY SOS",
    sosTriggered: "SOS TRANSMITTED! RESCUE DISPATCHED",
    voiceSosPrompt: "Hold mic and speak in your language (e.g., 'Brahmaputra water inside house, 5 people trapped')...",
    safeRoute: "Safe Evacuation Path",
    offlineNotice: "OFFLINE MODE ACTIVE • Satellite data cached locally",
    evacuateNow: "IMMEDIATE EVACUATION DIRECTED! Move to designated highland.",
  ...
  as: {
    ...
    systemTitle: "উত্তৰ-পূৰ্বাঞ্চলৰ স্বায়ত্তশাসিত দুৰ্যোগ সতৰ্কবাৰ্তা আৰু জীৱন-ৰক্ষা ব্যৱস্থা",
    roleCitizen: "নাগৰিক সুৰক্ষা কেন্দ্ৰ",
    roleWarRoom: "কমাণ্ড ৱাৰ ৰুম (MDoNER)",
    roleResponder: "এনডিআৰএফ / উদ্ধাৰকাৰী দল",
    roleHospital: "আশ্ৰয় শিবিৰ আৰু চিকিৎসালয়",
    sosButton: "জৰুৰীকালীন SOS (সহায় লাগে)",
    sosTriggered: "SOS প্ৰেৰণ কৰা হ'ল! উদ্ধাৰকাৰী দল আহি আছে",
    voiceSosPrompt: "মাইক টিপি আপোনাৰ ভাষাত কওক (যেনে: 'ব্ৰহ্মপুত্ৰৰ পানী ঘৰত সোমাইছে, ৫ জন মানুহ আবদ্ধ')...",
    safeRoute: "নিৰাপদ স্থানান্তৰ পথ",
    offlineNotice: "অফলাইন ম'ড সক্ৰিয় • ডেটা সুৰক্ষিতভাৱে সঞ্চিত",
    evacuateNow: "তত্কালীন স্থান খালী কৰাৰ নিৰ্দেশ! ওখ স্থানলৈ যাওক।",
  ...
  hi: {
    name: "हिंदी (Hindi)",
    systemTitle: "पूर्वोत्तर क्षेत्र स्वायत्त आपदा पूर्व चेतावनी एवं जीवन-रक्षक प्रणाली",
    roleCitizen: "नागरिक सुरक्षा हब",
    roleWarRoom: "कमांड वॉर रूम (MDoNER)",
  ...
  bn: {
    name: "বাংলা (Bengali - NE / Tripura / Barak)",
    systemTitle: "উত্তর-পূর্বাঞ্চল দুর্যোগ পূর্ব সতর্কতা ও জীবন রক্ষা ব্যবস্থা",
    roleCitizen: "নাগরিক সুরক্ষা হাব",
    roleWarRoom: "কমান্ড ওয়ার রুম (MDoNER)",
  ...
  te: {
    ...
    evacuateNow: "తక్షణమే ఖాళీ చేయండి!",
