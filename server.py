...
SYSTEM_STATE = {
    ...
    "active_calamities": [
        ...
        {
            "id": "CAL-06",
            "type": "SEVERE_AIR_POLLUTION",
            "title": "Delhi-NCR Severe Thermal Inversion & PM2.5 Smog Emergency",
            "region": "National Capital Region (Delhi, Noida, Gurugram)",
            ...
            "pm10": 440.0,
            "aqi": 395,
            "affected_population": 18500000,
            "evacuation_status": "HEALTH_EMERGENCY_GRAP_STAGE_IV",
            "safe_shelter": "HEPA-Filtered Indoor Public Shelters",
            "siren_active": False,
            "last_updated": datetime.now().strftime("%H:%M:%S")
        },
        {
            "id": "CAL-07",
            "type": "GLOF",
            "title": "South Lhonak Glacial Outburst & Teesta Surge Alert",
            "region": "Chungthang & Singtam, Sikkim",
            "coordinates": [27.7010, 88.6120],
            "severity": "CRITICAL",
            "risk_score": 96,
            "surge_height_m": 8.5,
            "affected_population": 42000,
            "evacuation_status": "IMMEDIATE_RIDGE_EVACUATION",
            "safe_shelter": "ITBP High-Altitude Staging Camp",
            "siren_active": True,
            "last_updated": datetime.now().strftime("%H:%M:%S")
        },
        {
            "id": "CAL-08",
            "type": "RIVER_AVULSION",
            "title": "Kosi River Embankment Pressure & Widespread Inundation",
            "region": "Supaul & Saharsa, Bihar",
            "coordinates": [26.1260, 86.6020],
            "severity": "HIGH",
            "risk_score": 89,
            "water_discharge_cusecs": 385000,
            "affected_population": 520000,
            "evacuation_status": "EMBANKMENT_HIGH_GROUND",
            "safe_shelter": "State Multi-Purpose Elevated Flood Shelters",
            "siren_active": False,
            "last_updated": datetime.now().strftime("%H:%M:%S")
        },
        {
            "id": "CAL-09",
            "type": "URBAN_DELUGE",
            "title": "Mithi River Extreme Tidal Lock & Mega Stormwater Deluge",
            "region": "Kurla, Sion & BKC, Mumbai, Maharashtra",
            "coordinates": [19.0760, 72.8777],
            "severity": "HIGH",
            "risk_score": 90,
            "rainfall_rate_mmh": 85.0,
            "affected_population": 650000,
            "evacuation_status": "TRANSIT_CAMP_DISPATCH",
            "safe_shelter": "BKC Elevated Railway Shelter Complex",
            "siren_active": False,
            "last_updated": datetime.now().strftime("%H:%M:%S")
        }
    ],
